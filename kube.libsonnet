...
// Originally from: https://github.com/bitnami-labs/kube-libsonnet
// Forked to: https://github.com/kube-libsonnet/kube-libsonnet
//
...

{
  ...
  VerticalPodAutoscaler(name):: $._Object('autoscaling.k8s.io/v1', 'VerticalPodAutoscaler', name) {
    local vpa = self,
